...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Widget build(BuildContext context) {
    final itemYgDibersihkan =
        widget.item["item_yang_dibersihkan"] as List<dynamic>;
    return Scaffold(
      body: Container(
        width: 1.0.w,
        height: 1.0.h,
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child:
              ...
              V(32),
              CardTextComponent("Nama customer", widget.item["nama_lengkap"]),
              V(16),
              ...
              V(16),
              CardTextComponent(
                  "Staff Yang Melayani", widget.item["nama_staff"]),
              V(16),
              CardTextComponent(
              ...
              V(24),
              CardTextComponent("Daya listrik", "${widget.item["daya"]} watt"),
              V(16),
              CardTextComponent(
                  "Mengetahui yukbersihin dari ?", widget.item["mengetahui"]),
              V(16),
              CardTextComponent(
                  "Alamat lengkap", widget.item["alamat_lengkap"]),
              V(32),
              Center(
                child: LinkComponent(
                  "Lihat Lokasi >",
