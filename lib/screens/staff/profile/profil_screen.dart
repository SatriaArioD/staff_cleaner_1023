                  ...
                  children: [
                    Stack(children: [
                      SizedBox(
                          ...
                          child: const Image(
                              image:
                                  AssetImage('assets/images/bg_profile.png'))),
                      Positioned(
                          top: 0.07.h,
                          left: 16,
                          child: const TextComponent("Profile")),
                      SizedBox(
                        height: 0.38.h,
                        child: Align(
                          ...
                          child: AvatarComponent(
                            ...
                            onGetImage: (image) async {
                              try {
                                ...
                                final urlImage =
                                    await fs.uploadFile(image, "images");

                                await fs.updateDataSpecifictDoc(
                                    "staff", data.id, {"image": urlImage});
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              V(16),
                              SectionDataProfile(
                                  Icons.calendar_month, data["tanggal_lahir"]),
                              V(48),
                              Center(
